This package provides a way to bundle an [astilectron](https://github.com/audrius-paskevicius/asticode-go-astilectron) app using the [bootstrap](https://github.com/audrius-paskevicius/asticode-go-astilectron-bootstrap).

Check out the [demo](https://github.com/audrius-paskevicius/asticode-go-astilectron-demo) to see a working example.
...
```shell
FATA[0009] bundling failed: bundling for environment linux/amd64 failed: building failed: # github.com/audrius-paskevicius/asticode-go-astilectron-demo
...
Thanks to [this comment](https://github.com/audrius-paskevicius/asticode-go-astilectron-demo/issues/28#issuecomment-509050603), you need to add the `ldflags` key to your `bundler.json` with the value `{"linkmode":["internal"]}`.
